    ...
    return (
        <div className="flex gap-4 max-w-5xl mx-auto p-4">
            ...
            {showNavigation && (
                ...
                >
                <svg
                className={`w-5 h-5 ${isAtStart ? "text-gray-400" : "text-gray-700 group-hover:text-white"}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                >
            ...
            >
            <svg
              className={`w-5 h-5 ${isAtEnd ? "text-gray-400" : "text-gray-700 group-hover:text-white"}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
